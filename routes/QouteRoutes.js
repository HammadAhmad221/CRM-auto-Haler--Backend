...
// Create a new quote
router.post('/', async (req, res) => {
  const { customerId, vehicleId, distance, vehicleType, price, status } = req.body;
...
router.put('/:id', async (req, res) => {
  ...
  try {
    const updatedQuote = await Quote.findByIdAndUpdate(
      id,
      { customerId, vehicleId, distance, vehicleType, price, status },
      { new: true }
    );
...
router.put('/:id/approve', async (req, res) => {
  ...
  try {
    ...
    quote.status = 'Approved'; // Or any other status you use for approval
